      ...
      <div className="flex h-full flex-col bg-gradient-to-b from-[#1c2205] via-[#111403] to-[#0a0b02] px-5 pt-6 pb-10 [clip-path:polygon(0_3%,50%_0,100%_3%,100%_90%,50%_100%,0_90%)]">
        <div className="flex items-start justify-between">
          <div className="text-center">
            ...
            <p className="mt-1 text-[10px] tracking-widest text-volt/60 uppercase">
              {footLabel || "Pie"}
            </p>
          </div>
          <p className="font-display text-sm leading-tight tracking-widest text-foreground/50">
            DREAM
            <br />
            TEAM
          </p>
        ...
        <div className="mt-3 flex justify-center">
          {photoUrl ? (
            ...
            <div className="flex size-28 items-center justify-center rounded-full border-2 border-dashed border-volt/30 bg-secondary/60">
        ...
        <div className="mx-auto mt-2 h-px w-3/4 bg-volt/30" />
        ...
        {teamName ? (
          <p className="mt-auto pt-3 text-center font-display text-sm tracking-widest text-volt/80 uppercase">
            {teamName}
          </p>
        ) : null}
      </div>
